...
export function pixelToTilePosition(x, y) {
...
export function tileToPixelPosition(x, y) {
    var tile = AreaMap.getCurrent().getTileSize();
    return {
        x: tile.width * (x + 0.5),
        y: tile.height * (y + 0.5)
...
Array.prototype.indexOfArray = function (other) {
    var ret = -1;
...
Array.prototype.equals = function (other, orderMatters = true) {
...
Map.prototype.getValueSet = function () {
